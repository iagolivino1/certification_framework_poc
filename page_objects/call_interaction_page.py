...
class CallInteractionPage(object):
    def __init__(self, driver=None):
        ...
        self.worksheet_next_question_button = "//button[contains(@class, 'ws_next_btn')] | //button[@id='ws_next_btn'] | //button[@id='ws_next_btn']"
        self.worksheet_previous_question_button = "//button[contains(@class, 'ws_prev_btn')] | //button[@id='ws_prev_btn'] | //button[@id='ws_prev_btn'"
        self.worksheet_finish_question_button = "//button[contains(@class, 'ws_finish_btnbtn')] | //button[@id='ws_finish_btn'] | //button[@id='ws_finish_btn']"
